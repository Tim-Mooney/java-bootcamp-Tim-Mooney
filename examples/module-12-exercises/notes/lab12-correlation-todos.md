...
Log on activate entry: log.info("name", customerId, "lab-request-001")
Log on activate success for Ravi: log.info("Ravi", customerId, "lab-request-001")
Never log field: Personal information like passwords or emails.
Place correlation in: header (header/MDC — pick one for now)
