...
| --- | --- | --- |
| Manual `new` | Service constructs InMemoryCustomerRepositor | Hard to swap fakes |
...
## Fix (one sentence)
declare CustomerRepository in the constructor; let the container (or test) supply it
